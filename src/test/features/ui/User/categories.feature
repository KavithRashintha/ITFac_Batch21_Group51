@categories
Feature: Category Management - User UI
    ...
    Scenario: Verify that clicking the Reset button clears the entered search criteria
        ...
        And user enters "Sub_Cat 3" in the search bar
        And user clicks on the search button
        And the search results should display category/subcategory "Sub_Cat 3"
